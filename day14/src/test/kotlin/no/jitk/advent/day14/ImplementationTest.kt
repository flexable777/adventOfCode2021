...
internal class ImplementationTest {
    ...
    fun `original test part 1`() {
        ...
        assertThat(processDay14Part1(lines)).isEqualTo(0)
    }
    ...
    fun `actual run part 1`() {
        ...
        val millis = measureTimeMillis {
            println("Actual run part 1: " + processDay14Part1(lines))
        }
    ...
    fun `original test part 2`() {
        ...
        assertThat(processDay14Part2(lines)).isEqualTo(0)
    }
    ...
    fun `actual run part 2`() {
        ...
        val millis = measureTimeMillis {
            println("Actual run part 2: " + processDay14Part2(lines))
        }
