...
internal class ImplementationTest {
    ...
    fun `original test part 1`() {
        ...
        assertThat(processDayXPart1(lines)).isEqualTo(0)
    }
    ...
    fun `actual run part 1`() {
        ...
        val millis = measureTimeMillis {
            println("Actual run part 1: " + processDayXPart1(lines))
        }
    ...
    fun `original test part 2`() {
        ...
        assertThat(processDayXPart2(lines)).isEqualTo(0)
    }
    ...
    fun `actual run part 2`() {
        ...
        val millis = measureTimeMillis {
            println("Actual run part 2: " + processDayXPart2(lines))
        }
